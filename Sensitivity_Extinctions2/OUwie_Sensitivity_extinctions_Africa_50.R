...
threshold50 <- quantile(mega_afr$logFS, probs=c(0.50))
extinctions50 <- mega_afr$SpecName[mega_afr$accAfrica == 1 & mega_afr$logFS >= threshold50 
                                   & mega_afr$Asia == FALSE & mega_afr$Americas== FALSE]
...
saveRDS(bestfit, file.path(output_dir, paste0("Bestfit_50", task_id, ".rds")))
saveRDS(mods2, file.path(output_dir, paste0("Raw_50", task_id, ".rds")))
saveRDS(mods5, file.path(output_dir, paste0("Processed_50", task_id, ".rds")))
